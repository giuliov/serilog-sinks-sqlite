...
internal class SQLiteSink : BatchProvider, ILogEventSink
{
        ...
        bool rollOver = true) : base(batchSize: (int)batchSize, maxBufferSize: 100_000)
    {
        ...
        {
            throw new SqliteException($"Database size greater than {MaxSupportedDatabaseSize} MB is not supported", -1);
        }
    ...
    private SqliteConnection GetSqLiteConnection()
    {
        ...
        string pragmas = "PRAGMA journal_mode=wal;";
        var sqlCommand = new SqliteCommand(pragmas, sqLiteConnection);
